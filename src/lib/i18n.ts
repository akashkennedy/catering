...
export const ui = {
  ...
  events: {
    ...
    statusPlanned: lab("Planned", "திட்டமிடப்பட்டது"),
    statusConfirmed: lab("Confirmed", "உறுதிசெய்யப்பட்டது"),
    statusCompleted: lab("Completed", "முடிந்தது"),
    statusCancelled: lab("Cancelled", "ரத்துசெய்யப்பட்டது"),
    paymentPending: lab("Pending", "நிலுவையில்"),
    paymentPartial: lab("Partial", "பகுதியாக"),
    paymentPaid: lab("Paid", "செலுத்தப்பட்டது"),
    noIngredients: lab(
